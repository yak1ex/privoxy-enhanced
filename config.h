 ...
 */
#define VERSION "3.0.21-y0"

/*
 * Version number of referenced document, as a string
 */
#define DOC_VERSION "3.0.21"
 ...
 */
#define FEATURE_ADD_REFERER 1

/*
 * Enables forward class selection.
 */
#define FEATURE_FORWARD_CLASS 1

/*
 * Enables manual tagger.
 */
#define FEATURE_MANUAL_TAGGER 1

/*
 * Enables required tag.
 */
#define FEATURE_REQUIRED_TAG 1
